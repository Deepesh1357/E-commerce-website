...
class MySetPasswordForm(SetPasswordForm):
    ...
    new_password2 = forms.CharField(label=_("Confirm New Password"),strip= False, widget=forms.PasswordInput(attrs={'autocomplete':'New-password','autocomplete':'new-password','class':'form-control'}))
